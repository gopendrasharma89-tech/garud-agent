...
> **Version:** 3.6.0 "Nimbus" · Released 2026-05-23
...
└── logs/
    └── 2026-05-23.md  # daily activity log
```
...
- 🦅 **Mascot** — `garud mascot` shows the Nimbus falcon
...
npm run cli version         # garud-agent 3.6.0
