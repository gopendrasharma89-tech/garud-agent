...
[![Tests](https://img.shields.io/badge/tests-516%20passing-brightgreen)](https://github.com/gopendrasharma89-tech/garud-agent/actions)
...
> **Version:** 3.0.0 "Skyforge" · Released 2026-05-17
...
└── logs/
    └── 2026-05-17.md  # daily activity log
```
...
npm run cli version         # garud-agent 3.0.0
