...
> **Version:** 3.7.0 "Altocumulus" · Released 2026-05-24
...
└── logs/
    └── 2026-05-24.md  # daily activity log
```
...
- 🦅 **Mascot** — `garud mascot` shows the Altocumulus falcon
...
npm run cli version         # garud-agent 3.7.0
...
| Source files | 73 |
| Test files | 56 |
| Lines of TypeScript | 19,660 |
| Built-in tools | 165 |
| HTTP endpoints | ~77 |
| Test suites | 56 |
| Tests | 659 (all passing) |
| Test runtime | ~17 s |
