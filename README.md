...
> **Version:** 3.4.0 "Stratus" · Released 2026-05-21
...
└── logs/
    └── 2026-05-21.md  # daily activity log
```
...
- 🦅 **Mascot** — `garud mascot` shows the Stratus falcon
...
npm run cli version         # garud-agent 3.4.0
npm run cli tools           # list all 154 tools
...
| Source files | 65 |
| Test files | 51 |
| Lines of TypeScript | 17,379 |
| Built-in tools | 154 |
| HTTP endpoints | ~60 |
| Test suites | 51 |
| Tests | 596 (all passing) |
| Test runtime | ~17 s |
