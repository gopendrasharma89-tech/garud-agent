...
**Version:** 0.9.0 "Shakti" · Released 2026-05-04 · Zero runtime dependencies · Strict TypeScript

## Highlights
- **84 built-in tools** (memory, math, text, json, crypto, time, geo, validate, color, array, uuid, ...)
- **381 tests pass** across 35 suites in ~12s
