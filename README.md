...
> **Version:** 3.8.0 "Nimbostratus" · Released 2026-05-25
...
└── logs/
    └── 2026-05-25.md  # daily activity log
```
...
- 🦅 **Mascot** — `garud mascot` shows the Nimbostratus falcon
...
npm run cli version         # garud-agent 3.8.0
